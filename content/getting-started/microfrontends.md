...
### Quickstart: How to scaffold a blueprint application
...
Additionaly you can add separate *README.md* for each plugin/blueprint separately. All you have to do is:
