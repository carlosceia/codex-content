...
The decision tree can be read from top (most effort, highest customization) to bottom (lowest
...
The properties are explained in detail in the step-by-step scaffolding of a micro frontend. However,
